...
rm -r -f /home/playtron/.local/share/playtron/apps/local/{chiaki4deck,Chrome,desktop,Firefox,Heroic,Minecraft,"NVIDIA GeForce NOW",NVIDIA_GeForce_NOW,RetroArch,RetroDeck,"Xbox Cloud Gaming",Xbox_Cloud_Gaming}/
